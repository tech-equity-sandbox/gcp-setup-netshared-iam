...
Depending on the platform setup, the asset may initialize automatically or may need to be manually executed. To manually execute the asset, run the command `./gcp-setup-net-iam.sh` on the terminal.
...
## Configure Network, Identity and Access Management

This asset enables you to explore the process for configuring networking, identity and access management. 
...
- Create and configure host, application and secret service accounts and policy bindings
- Create and configure host network and firewall rules
